...
?>
	...
	<div id='admin_add' ng-show="c_admin.context === 'add'" class='adminbar slide_d'>
		<div>
			...
			<!-- Chapter -->
			<form class='admin_section' name='addchap' ng-submit='submit("chapter",c_admin.achap_name,c.context.sid,null,null)' ng-hide="c_admin.astory_name || c_admin.apage_name || !all.a.story.sid || !c.allowed" novalidate>
				<h1>New Chapter</h1>
				<div class='infield'>
			...
			<!-- Page -->
			<form  class='admin_section' name='addpage' ng-submit='submit("page",c_admin.apage_name,c.context.sid,c.context.chid,null)' ng-hide="c_admin.astory_name || c_admin.achap_name || !all.a.story.sid || c.context.chid==-1 || !c.allowed" novalidate>
				<h1>New Page</h1>
				<div class='infield'>
